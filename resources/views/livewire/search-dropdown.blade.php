                        ...
                        <ul>
                            @foreach ($searchResults as $result)
                                <li class="transition duration-150 ease-in-out border-b border-gray-300 hover:bg-gray-50">
                                    <a href="{{ route('films.show', $result['id']) }}" class="flex items-center w-full px-3 py-2 transition duration-150 ease-in-out" @if ($loop->last) @keydown.tab="isOpen = false" @endif>
